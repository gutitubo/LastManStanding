...
public class LMSGame {
	...
	public void startTimer() {
		...
		for (Player p: players) {
			p.addPotionEffect(new PotionEffect(PotionEffectType.SPEED, 20*ConfigValue.waitingTime, 2, false, false), true);
			p.addPotionEffect(new PotionEffect(PotionEffectType.JUMP, 20*ConfigValue.waitingTime, 0, false, false), true);
		}
